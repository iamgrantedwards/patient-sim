...
# Disable dotenv before application modules are imported during test collection.
...
def configured(monkeypatch):
    ...
    values = {
        ...
        "SIP_OUTBOUND_TRUNK_ID": "ST_fixture",
        ...
        "ENDPOINTING_MIN_DELAY": "0.4",
        "ENDPOINTING_MAX_DELAY": "6",
    }
