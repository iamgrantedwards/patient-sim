...
class Config:
    ...
    def pipeline(self) -> dict:
        ...
        return {
            "stt": self.stt_model, "stt_language": self.stt_language,
            "llm": self.llm_model, "llm_temperature": 0.4,
            "tts": self.tts_model, "tts_voice": self.tts_voice,
            "turn_detection": self.turn_detection,
            "turn_detector_version": "v1-mini" if self.turn_detection == "default" else None,
            "endpointing": {"mode": self.endpointing_mode,
                            "min_delay": self.endpointing_min_delay,
                            "max_delay": self.endpointing_max_delay},
            "interruption": {"mode": "vad"}, "preemptive_generation": False,
            "ivr_detection": False, "noise_cancellation": False, "auto_gain_control": False,
        }
