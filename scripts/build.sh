...
assert all((ASSETS / name).is_file() for name in ("index.html", "app.js", "console.js", "learning.js", "reviews.js", "assessments.js", "assessments.css", "theme.js", "style.css", "theme.css", "favicon.svg"))
