...
after #77). No further application development or calling is planned.
...
| At least 10 full conversations, each with both-sided audio and transcript | Original ten-candidate set (20.59 minutes) plus later retests; freeze inventory is 19 attempts / 18 file pairs. See COLLECTION.md. No saved human acceptance or public raw-call files at audit; captured files are not automatically accepted pairs |
